...
class Att_Lstm_Config():
    seq_length = 180  # max length of sentence
    num_labels = 7  # number of labels

    hidden_size = 100  # number of fully_connected layer units
    keep_prob = 0.5
    dropout_keep_prob = 0.5  # droppout
    ...
    training_data = data_dir + 'result_fold5_training.txt'
    dev_data = data_dir + 'result_fold5_test.txt'
    test_data = data_dir + 'result_fold5_test.txt'
